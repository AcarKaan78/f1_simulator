...
public class Team {
    ...
    */
    ...
    public void addRacer(Racer _racer) {
        if(headRacer == null) {
            headRacer = _racer;
            //System.out.println(teamID+" | "+teamName+" takýmýna yarýscý "+headRacer.racerID+" | "+headRacer.racerName+" katýlmýstýr.");
        }
        else{
            Racer curr=headRacer;
            ...
            //System.out.println(curr.racerID+" | "+curr.racerName+" yarýscýsýndan sonra, "+teamID+" | "+teamName+" takýmýna, yarýscý "+curr.nextRacer.racerID+" | "+curr.nextRacer.racerName+" katýlmýstýr.");
        }
    }
    ...
    public Racer removeLastRacer() {
        ...
        if(headRacer.nextRacer==null) {
            ...
            //System.out.println("liste içerisinde ki sonuncu eleman olan {"+curr.nextRacer.racerID+" | "+curr.nextRacer.racerName+"} silinmiþtir");
